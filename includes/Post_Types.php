...
final class Post_Types
{
    ...
    public function hooks(): void
    {
        ...
        add_action('save_post_' . self::APP_POST_TYPE, [$this, 'save_app_meta']);
        add_action('admin_notices', [$this, 'render_admin_notices']);
    }

    public static function register(): void
    {
        register_post_type(self::APP_POST_TYPE, [
            'labels' => [
    ...
    {
        $preview = $attachment_id > 0 ? wp_get_attachment_image($attachment_id, 'thumbnail', false, ['style' => 'max-width:100%;height:auto;margin-top:8px;']) : '';
