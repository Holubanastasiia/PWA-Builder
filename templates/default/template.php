...
$button_settings = $field('button_settings', []);
$button_settings = is_array($button_settings) ? $button_settings : [];
$button_start = isset($button_settings['button_start_mode']) && is_array($button_settings['button_start_mode']) ? $button_settings['button_start_mode'] : [];
$button_loading = isset($button_settings['button_loading_mode']) && is_array($button_settings['button_loading_mode']) ? $button_settings['button_loading_mode'] : [];
$button_ready = isset($button_settings['button_ready_mode']) && is_array($button_settings['button_ready_mode']) ? $button_settings['button_ready_mode'] : [];
